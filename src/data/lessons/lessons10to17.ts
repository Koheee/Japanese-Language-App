  ...
  grammar: [
    {
      ...
      explanation: 'Build this connector by verb group: る-verbs use ～て; う・つ・る become ～って, む・ぶ・ぬ become ～んで, く becomes ～いて, ぐ becomes ～いで, and す becomes ～して. する gives して, 来ます gives きて, and 行きます exceptionally gives 行って.',
      ...
      notes: ['Choose the group from the verb, not simply from the kana immediately before ます.', 'The voiced で forms after む・ぶ・ぬ and ぐ are part of the conjugation, not a particle.'],
      examples: [
  ...
  grammar: [
    {
      ...
      explanation: 'For Group 1, change the final kana of the basic verb from its u-row sound to the matching a-row sound and add ない; final う becomes わない. For Group 2, drop final る and add ない. The irregular forms are する→しない and 来る→こない.',
      ...
      usageBoundary: 'Apply the correct group rule: 書く→書かない, 読む→読まない, 待つ→待たない, 買う→買わない, and 見る→見ない; ある exceptionally becomes ない. Systematic base-form analysis is deferred to Lesson 18.',
      notes: ['Group 1 changes the final u-row sound to its a-row partner; final う uniquely changes to わ.', 'Group 2 removes る; する and 来る are irregular.'],
      examples: [
